...
imported from phase1_data_extraction/isikdere_phase1_dataset.json, EXCEPT the Tm entry, which
...
_CANDIDATES = [
    _HERE.parent / "phase1_data_extraction" / "isikdere_phase1_dataset.json",
]
