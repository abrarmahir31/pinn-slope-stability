#!/usr/bin/env python
"""
15_ic_overlay.py -- Day 14 verification: digitised geometry against the source raster.
...
Run from phase3_geometry_bc_ic/:

    python 15_ic_overlay.py --discover      # find CSVs and the raster, print sizes
    python 15_ic_overlay.py --grid          # overlay + coordinate grid, to fix calibration
    python 15_ic_overlay.py                 # final figure -> output/fig03_domain_overlay.png
